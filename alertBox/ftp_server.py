...
from helper import close_port_wrapper, get_free_port, kill_server_wrapper, setup_logger, disable_logger, set_local_vars, check_if_server_is_running
...
class QFTPServer():
    ...
    def ftp_server_main(self):
        ...
        factory.welcomeMessage = "ProFTPD 1.3.6"
...
if __name__ == '__main__':
        ...
        ftpserver = QFTPServer(ip="0.0.0.0", port=21, username="admin", password="Passw0rd", options=["capture_commands"], config=config)
